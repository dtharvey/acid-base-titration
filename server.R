...
indicator.name = c("bromophenol blue (3.0-4.6)","bromocresol green (3.8-5.4)", 
                   "methyl red (4.2-6.3)",
                   "bromocresol purple (5.2-6.8)", "bromothymol blue (6.0-7.6)", 
                   "phenol red (6.8-8.4)", "cresol red (7.2-8.8)", 
                   "p-naphtholbenzein (9.0-11.0)", "alizarin yellow R (10.1-12.0)")
acid.color = c(5,5,8,5,5,5,5,5,5)
acid.limit = c(3.0,3.8,4.2,5.2,6.0,6.8,7.2,9.0,10.1)
base.color = c(3,3,5,8,3,3,8,3,8)
base.limit = c(4.6,5.4,6.3,6.8,7.6,8.4,8.8,11.0,12.0)
